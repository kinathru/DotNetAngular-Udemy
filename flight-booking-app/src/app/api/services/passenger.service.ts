...
import { registerPassenger$Plain } from '../fn/passenger/register-passenger-plain';
import { RegisterPassenger$Plain$Params } from '../fn/passenger/register-passenger-plain';
...
export class PassengerService extends BaseService {
   ...
   */
  registerPassenger$Plain$Response(params?: RegisterPassenger$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<NewPassengerDto>> {
    return registerPassenger$Plain(this.http, this.rootUrl, params, context);
  }
   ...
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  registerPassenger$Plain(params?: RegisterPassenger$Plain$Params, context?: HttpContext): Observable<NewPassengerDto> {
    return this.registerPassenger$Plain$Response(params, context).pipe(
      map((r: StrictHttpResponse<NewPassengerDto>): NewPassengerDto => r.body)
    );
  }
   ...
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  registerPassenger$Response(params?: RegisterPassenger$Params, context?: HttpContext): Observable<StrictHttpResponse<NewPassengerDto>> {
   ...
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  registerPassenger(params?: RegisterPassenger$Params, context?: HttpContext): Observable<NewPassengerDto> {
